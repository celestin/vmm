...
class vmm_ral_sys extends vmm_ral_block_or_sys;
   ...
   //------------------------------------------------------------------------------
   // FUNCTION: new
   // Creates an instance of a RAL model with the corresponding system as the top-level structural
   ...
   // the -c option can be enabled.
   //
   // Because the functional coverage models affect the memory
   // footprint and runtime performance of a RAL model, they should be enabled only when relevant.
   //
   // It is not possible to enable a functional coverage model at a later time, but it is possible to
   // turn the measurement of a functional coverage model off and on using the <vmm_ral_block::set_cover>
   // method. 
   //------------------------------------------------------------------------------
   extern function new(
   ...
   //------------------------------------------------------------------------------
   // FUNCTION: get_blocks
   // Fills the specified dynamic arrays with the abstraction classes and their domain name
   // for all of the blocks directly instantiated in the system.
   //
   // The order in which the blocks
   // are located in the array is not specified. The name returned in domains[i] corresponds
   // to the domain name within blocks[i] that is instantiated in the system.
   //
   // If a domain name
   // is specified, only the blocks instantiated in the specified domain are included. The
   // order in which the blocks are located in the array is not specified. 
   //------------------------------------------------------------------------------
   ...
   // Finds a block with the specified name in the system and returns its descriptor. If no
   // blocks are found, returns null.
   //
   // Block name uniqueness is guaranteed only within a single
   // system. Therefore, if used on a system with more than one block having the same name but
   // in different subsystems, this method returns the first block found. 
   //------------------------------------------------------------------------------
   ...
   //------------------------------------------------------------------------------
   // FUNCTION: get_subsys
   // Fills the specified dynamic arrays with the abstraction classes and domain names for
   // all of the subsystems directly instantiated in the system.
   //
   // The name returned in domains[i]
   // corresponds to the domain name within subsys[i] that is instantiated in the system.
   ...
   //------------------------------------------------------------------------------
   // FUNCTION: get_all_subsys
   // Fills the specified dynamic arrays with the abstraction classes and domain names for
   // all of the subsystems instantiated in the system and subsystems it contains.
   //
   // The name
   // returned in domains[i] corresponds to the domain name within subsys[i] that is instantiated
   // in the system.
   //
   // If a domain is specified, only those subsystems accessible in that domain
   // are returned. The order in which the subsystems are located in the array is not specified.
   // 
   //------------------------------------------------------------------------------
   ...
   //------------------------------------------------------------------------------
   // FUNCTION: get_subsys_by_name
   // Finds a subsystem with the specified name in the system and returns its descriptor.
   // If no system is found, returns null.
   //
   // Subsystem name uniqueness is guaranteed only within
   // a single system.
   //
   // Therefore, if used on a system with more than one subsystem having the
   // same name but in different subsystems, this method returns the first subsystem found.
   // 
   //------------------------------------------------------------------------------
