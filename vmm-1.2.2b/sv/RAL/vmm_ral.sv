...
//------------------------------------------------------------------------------
// CLASS: vmm_ral
// Utility class for global symbolic values. Each set of symbolic values is specified
// using enumerated types. The symbolic values are accessed using a fully-qualified
// name, such as vmm_ral::RW. A separate encapsulating class is used to minimize the length
...
class vmm_ral;
 ...
 `ifdef VMM_12_UNDERPIN_VMM_RAL
   static bit ral_space = vmm_object::create_namespace("RAL");
 `endif		
