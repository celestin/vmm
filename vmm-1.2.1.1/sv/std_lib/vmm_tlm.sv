...
(* _vcs_vmm_class  = 1 *)
`endif
class vmm_tlm_initiator_socket#(type INITIATOR = vmm_tlm_xactor#(vmm_data, vmm_tlm::phase_e), type DATA = vmm_data, type PHASE = vmm_tlm::phase_e) extends vmm_tlm_socket_base#(DATA,PHASE);
...
(* _vcs_vmm_class  = 1 *)
`endif
class vmm_tlm_target_socket#(type TARGET = vmm_tlm_xactor#(vmm_data, vmm_tlm::phase_e), type DATA = vmm_data, type PHASE = vmm_tlm::phase_e) extends vmm_tlm_socket_base#(DATA,PHASE);
