...
//-----------------------------------------------------------------------------
//
// Filename    : $Id: apb_master.sv,v 1.16 2006/06/01 03:57:36 alexw Exp $
//
// Created by  : Synopsys Inc. 09/01/2004
//               $Author: alexw $
//
// Author      : Alex Wakefield, Angshu Saha, Chris Spear
//
...
`define APB_MASTER_IF	apb_master_mp.master_cb
...
class apb_master extends vmm_xactor;
    ...
    // Lab4 - virtual apb_if.Master apb_master_mp
    // Lab4 - apb_trans_channel in_chan = null
    extern function new (string instance,                                //LAB4
                         integer stream_id = -1,                         //LAB4
                         virtual apb_if.Master apb_master_mp,            //LAB4
                         apb_trans_channel in_chan = null);              //LAB4
...
function apb_master::new(string instance,
  ...
  this.apb_master_mp = apb_master_mp;

  // Construct an input channel if needed, save a reference to the channel
...
task apb_master::main();
  ...
  // Start the super.main() to perform any base-class tasks
  super.main();
  ...
  forever begin
    ...
    `vmm_callback(apb_master_callbacks, master_post_tx(this, tr));      //LAB4
