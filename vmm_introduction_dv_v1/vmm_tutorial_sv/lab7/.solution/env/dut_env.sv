...
function void dut_env::build();
  ...
  begin                                                                  //LAB6
    apb_master_scb_callbacks  apb_mst_scb_cb  = new(scb);                //LAB6
    mst.append_callback(apb_mst_scb_cb);                                 //LAB6
  end                                                                    //LAB6
                                                                         //LAB6
  // Lab6 - Enclose the following 2 lines in a begin/end block
  ...
  begin                                                                  //LAB6
    apb_monitor_scb_callbacks  apb_mon_scb_cb  = new(scb);               //LAB6
    mon.append_callback(apb_mon_scb_cb);                                 //LAB6
  end                                                                    //LAB6
                                                                         //LAB6
  // Lab7 - Integrate the functional coverage using a callback object
  // Lab7 - The code will be very similar to the master scoreboard
  // Lab7 - integration code above, except the class name is
  // Lab7 - apb_master_cov_callbacks, and the new() has no argument
  begin                                                                  //LAB7
    apb_master_cov_callbacks cov_cb = new();                             //LAB7
    mst.append_callback(cov_cb);                                         //LAB7
  end                                                                    //LAB7
...
task dut_env::wait_for_end();
  ...
  fork                                                                   //LAB6
    ...
    scb.notify.wait_for(scb.DONE);                                       //LAB6
  join                                                                   //LAB6
                                                                         //LAB6
