...
// Lab7 -   }
// Lab7 - endclass
  class my_apb_trans extends apb_trans;                      //LAB7
    constraint lab7 {                                        //LAB7
      addr inside {0, 100, 1024};                            //LAB7
      data inside {0, 100, 1024};                            //LAB7
    }                                                        //LAB7
  endclass                                                   //LAB7
                                                             //LAB7   
...
// Lab7 - end
  begin                                                      //LAB7
    my_apb_trans trans = new();                              //LAB7
    env.gen.randomized_obj = trans;                          //LAB7
  end                                                        //LAB7
                                                             //LAB7
