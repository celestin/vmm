...
`ifdef VMM_TBLOG
function void vmm_consensus::tblog_result(vmm_debug::verbosity_e verbosity, string action);
   string tblog_str;
   tblog_str = {action, this.psdisplay()};
...
function void vmm_voter::oppose(string why="No reason specified");
   ...
   this.why = why;
`ifdef VMM_TBLOG
   if (this.consensus != null) this.consensus.tblog_result(vmm_debug::TRACE_SEV, `vmm_sformatf("[%s opposes]\n", this.name));
`endif   
endfunction: oppose
...
function void vmm_voter::consent(string why="No reason specified");
   ...
   this.why = why;
`ifdef VMM_TBLOG
  if (this.consensus != null) this.consensus.tblog_result(vmm_debug::TRACE_SEV, `vmm_sformatf("[%s consents]\n", this.name));
`endif   
endfunction: consent
...
function void vmm_voter::forced(string why="No reason specified");
   ...
   this.why = why;
`ifdef VMM_TBLOG
  if (this.consensus != null) this.consensus.tblog_result(vmm_debug::TRACE_SEV, `vmm_sformatf("[%s is forced]\n", this.name));
`endif    
endfunction: forced
