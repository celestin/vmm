...
virtual class utopia1_atm_callbacks extends vmm_xactor_callbacks;
   virtual task pre_cell_tx(utopia1_atm_layer xactor,
                            ref atm_cell      cell
                            ref utopia1_udf   udf,
                            ref bit           drop)
   endtask
   ...
   virtual task pre_symbol_tx(utopia1_atm_layer xactor,
                              ref bit [7:0]     symbol,
                              ref bit           SOC,
                              ref bit           Enb,
                              const bit         Clav,
   ...
   virtual task post_cell_rx(utopia1_atm_layer xactor,
                             const atm_cell    cell
                             const utopia1_udf udf)
   endtask

   virtual task post_symbol_rx(utopia1_atm_layer xactor,
...
endclass: utopia1_atm_callbacks


class utopia1_atm_layer extends vmm_xactor;

   virtual utopia1_if.atm_layer if;
