...
class initiator extends vmm_xactor;
  my_trans trans = new();
  vmm_tlm_nb_transport_port#(initiator, my_trans, my_vmm_tlm) socket = new(this, "initiator_put");
  ...
  function new(vmm_xactor parent, string name);
   ...
   virtual function vmm_tlm::sync_e nb_transport_bw(int id =-1, my_trans trans, my_vmm_tlm p, int delay);
...
class initiator_parent extends vmm_xactor;
  ...
  vmm_tlm_nb_transport_port#(initiator_parent, my_trans, my_vmm_tlm) socket = new(this, "initiator_P_put");
...
class target extends vmm_xactor;
   vmm_tlm_nb_transport_export#(target, my_trans, my_vmm_tlm) socket = new(this, "target_put"); 
  ...
  my_vmm_tlm l_ph;
   ...
   virtual protected task main();
      ...
      forever begin
         ...
         socket.nb_transport_bw( my_data, l_ph, 0);
      end
   endtask : main

   virtual function vmm_tlm::sync_e nb_transport_fw(int id =-1, my_trans trans, my_vmm_tlm p, int delay);
...
class target_parent extends vmm_xactor;
   target target_c;
   vmm_tlm_nb_transport_export#(target_parent, my_trans, my_vmm_tlm) socket = new(this, "target_P_put"); 
