...
class initiator extends vmm_xactor;
  my_trans trans = new();
  vmm_tlm_nb_transport_fw_port#(initiator, my_trans, my_vmm_tlm) socket = new(this, "initiator_put");
...
class initiator_parent extends vmm_xactor;
   ...
   vmm_tlm_nb_transport_fw_port#(initiator_parent, my_trans, my_vmm_tlm) socket = new(this, "initiator_P_put");
...
class target extends vmm_xactor;
   vmm_tlm_nb_transport_fw_export#(target, my_trans, my_vmm_tlm) socket = new(this, "target_put");
   ...
   virtual function vmm_tlm::sync_e nb_transport_fw(int id = -1, my_trans trans, my_vmm_tlm ph, int delay);
      ...
      return my_vmm_tlm::TLM_ACCEPTED;
   endfunction: nb_transport_fw

   /*virtual function my_vmm_tlm::sync_e nb_transport_bw(my_trans trans);
   endfunction 

   virtual task b_transport(my_trans trans);
   endtask : b_transport   */
endclass : target

class target_parent extends vmm_xactor;
   target target_c;
   vmm_tlm_nb_transport_fw_export#(target_parent, my_trans, my_vmm_tlm) socket = new(this, "target_P_put");
