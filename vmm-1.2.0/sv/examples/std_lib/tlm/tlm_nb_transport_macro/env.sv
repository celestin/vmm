...
class target extends vmm_xactor;
  ...
  virtual function vmm_tlm::sync_e nb_transport_fw1(int id = -1, my_data trans, vmm_tlm ph, int delay);
  ...
  virtual function vmm_tlm::sync_e nb_transport_fw2(int id = -1, my_data2 trans, vmm_tlm ph, int delay);
