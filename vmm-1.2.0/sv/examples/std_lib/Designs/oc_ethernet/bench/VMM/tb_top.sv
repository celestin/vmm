...
begin
   $write("%t: %h %b %b | %h %b %b | %b %b\n", $time(),
          mii.txd, mii.tx_en, mii.tx_err,
...
reg mii_100Mb;
// Example 4-11
integer tx_rx_offset; // rx posedge edge lags tx edge by 0-99% T
// Example 4-10
initial
begin
   integer T;
   ...
   #20; // No clock edge a T=0
   tx_clk = 0;
   rx_clk = 0;

   if (mii_100Mb) // 100 Mbps - 2510 ns
      T = 400;
   else // 10 Mbps - 100 ns
      T = 40;
