...
This distribution contains the following:
  ...
  - Source code for the VMM Standard Library (v1.2.0)
  - Source code for the VMM Register Abstraction Layer (v1.13)
  - Source code for the VMM Scoreboard Package (v1.4.2)
  - Source code for the VMM Performance Analyzer (v1.1.11)
  - Source code for the VMM Hardware Abstraction Layer (v2.0.1)
...
binaries.
   % setenv VMM_HOME path/vmm-1.2.0
...
srcdist/sv/examples/std_lib/Advanced
srcdist/sv/examples/std_lib
