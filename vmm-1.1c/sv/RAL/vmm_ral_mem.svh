...
class vmm_ral_mem;
   ...
   /*extern*/ /*local*/ function vmm_ral_access Xget_ral_accessX(); return null; endfunction
   ...
   extern virtual function void power_down();
   extern virtual function void power_up();
