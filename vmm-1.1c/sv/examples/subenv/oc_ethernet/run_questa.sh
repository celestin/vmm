...
vlib work
vlog $VLOG_ARGS blk_trivial_test.sv            && vsim $VSIM_ARGS blk_top test -l blk_trivial_test.log
vlog $VLOG_ARGS dual_eth.v sys_trivial_test.sv && vsim $VSIM_ARGS sys_top -suppress 8385 test -l sys_trivial_test.log
