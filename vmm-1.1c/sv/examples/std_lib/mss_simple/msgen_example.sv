    ...
    task execute(ref int n);
        fork
          begin
             ...
             void'(atm_scenario.randomize() with {atm_scenario.length == 1;});
          ...
          begin
             ...
             void'(cpu_scenario.randomize() with {cpu_scenario.length == 1;});
...
initial
  begin
    // must new xactors here because they fork processes
