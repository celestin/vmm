...
function void wb_master::reset_xactor(reset_e rst_typ = SOFT_RST);
   ...
   this.sigs.mck.wdat <= 64'bz;
   this.sigs.mck.wtgd <= 16'bz;
   this.sigs.mck.adr  <= 64'bz;
   this.sigs.mck.we   <= 1'bz;
   this.sigs.mck.cyc  <= 1'bz;
   this.sigs.mck.lock <= 1'bz;
   this.sigs.mck.sel  <= 8'bz;
   this.sigs.mck.stb  <= 1'bz;
   this.sigs.mck.tga  <= 16'bz;
   this.sigs.mck.tgc  <= 16'bz;
   this.sigs.mck.cti  <= 3'bz;
   this.sigs.mck.bte  <= 2'bz;
